...
const HeroSection = () => {
  ...
  const Submit = () => {
    if (!Number.trim()) {
      ...
      const config = {
        method: "POST",
        url: "http://api.dicelogistic.tech/con/contacting",
        data: data,
        headers: {
                ...
                {prams == "/" ?
                  <div className="text w-100 text-center mb-md-5 pb-md-5">
                    ...
                    <p style={{ fontSize: "18px" }}>
                      Ready to join Dice Logistic family? Submit your application.
                    </p>
                  ...
                  : prams == "/about" ? <div className="text w-100 text-center mb-md-5 pb-md-5">
                    ...
                    <p style={{ fontSize: "18px", lineHeight: "29px", }}>
                      Dice Logistic offers comprehensive dispatching and load management services designed
                      ...
                      <br />
                      Dice Logistic provides services for owner-operators, large fleets and any size business in between.
                    </p>
                  </div>
