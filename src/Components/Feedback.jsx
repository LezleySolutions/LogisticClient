                ...
                <OwlCarousel className="owl-carousel" {...options}>
                    ...
                    <div className="testimony-wrap rounded text-center py-4 pb-5">
                      ...
                      <div className="text pt-4">
                        <p className="mb-4">
                          ...
                          service companies before, but Dice Freight stands out
                  ...
                  <div className="item mx-3 rounded-5">
                    <div className="testimony-wrap rounded text-center py-4 pb-5">
                      ...
                      <div className="text pt-4">
                        <p className="mb-4">
                          Dice Freight has played a vital role in the success
                  ...
                  <div className="item mx-3 rounded-5">
                    <div className="testimony-wrap rounded text-center py-4 pb-5">
                      ...
                      <div className="text pt-4">
                        <p className="mb-4">
                          I can confidently say that Dice Freight
                  ...
                  <div className="item mx-3 rounded-5">
                    <div className="testimony-wrap rounded text-center py-4 pb-5">
                      ...
                      <div className="text pt-4">
                        <p className="mb-4">
                          The team at Dice Freight does an exceptional job
